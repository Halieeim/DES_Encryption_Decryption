 ...
 *
 * Names:-                                  IDs:-
 *          Ahmed Abd El-Halim Ahmed                20190045
 *
 ***/
public class DES {
    ...
    public static void main(String[] args){
        ...
        String key = "";
        while(key.length() != 8) {
            System.out.println("Please Enter new key of length 8 characters");
            key = input.nextLine();
        }
        ...
        ArrayList<String> keys = des.generate16Keys(key);
        System.out.println("\nKeys:\n");
        ...
        for(String block : blocks){
            decryptedText = decryptedText.concat(des.decrypt(block,key));
        }
